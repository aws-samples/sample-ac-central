...
const config: Config = {
  ...
  // Exposed to client-side components (e.g. FeedbackLink) via siteConfig.customFields.
  // Defaults to the GitHub issue URL; CI overrides ISSUE_URL per platform.
  customFields: {
    issueUrl:
      process.env.ISSUE_URL ||
      'https://github.com/aws-samples/sample-ac-central/issues/new',
  },
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Workshops',
          items: [
            {label: 'Getting Started with AgentCore', href: 'https://catalog.workshops.aws/agentcore-getting-started'},
            {label: 'Diving Deep into AgentCore', href: 'https://catalog.workshops.aws/agentcore-deep-dive'},
          ],
        },
      ],
